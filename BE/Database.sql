...
DROP DATABASE IF EXISTS Registerdemo;
-- Create database
CREATE DATABASE IF NOT EXISTS Registerdemo;
USE Registerdemo;
-- CHAR(50) NOT NULL UNIQUE CHECK (LENGTH(`username`) >= 6 AND LENGTH(`username`) <= 50),
...
CREATE TABLE `Group`(
    ...
    team_size		TINYINT	UNSIGNED DEFAULT 0,
...
-- Add data Group
INSERT INTO `Group`(`name`, team_size) 
VALUES
						(N'Marketing'	, 			1),
						(N'Sale'		, 			2),
						(N'Bảo vệ'		, 			3),
